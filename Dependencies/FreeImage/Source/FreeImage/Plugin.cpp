		...
		*/
		...
		if (s_plugins) {
			...
			*/
			...
			//s_plugins->AddNode(InitEXR); // emcc generates unnecessary big file
			s_plugins->AddNode(InitJ2K);
			s_plugins->AddNode(InitJP2);
			s_plugins->AddNode(InitPFM);
			s_plugins->AddNode(InitPICT);
			//s_plugins->AddNode(InitRAW); // emcc fails to compile this module
			s_plugins->AddNode(InitWEBP);
#if !(defined(_MSC_VER) && (_MSC_VER <= 1310))
			//s_plugins->AddNode(InitJXR); // emcc fails to compile this module
